...
const DiningPage: React.FC<DiningPageProps> = ({ products, onProductSelect }) => {
  ...
  return (
    <>
      <section 
        ...
        style={{ backgroundImage: "url('https://i.pinimg.com/1200x/0b/27/50/0b275037f9edd3595db75730492a8834.jpg')" }}
      >
        ...
        <div className="relative z-10 text-center text-ivory p-4">
          ...
          <AnimateOnScroll initialClass="opacity-0 translate-y-5" finalClass="opacity-100 translate-y-0" delay={200}>
            <p className="font-poppins text-lg md:text-xl max-w-2xl mx-auto font-light">
              Where memories are made and conversations linger.
            </p>
          </AnimateOnScroll>
        </div>
      </section>
